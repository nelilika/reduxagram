...
/* 
6) Напишите программу, которая спрашивает у пользователя два числа 
...
/*
7) Напишите програму, которая спрашивает у пользователя символ и выводит его 5 раз в консоль, увеличивая каждый раз на 1 их колличество.
