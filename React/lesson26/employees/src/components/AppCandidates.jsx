...
function App() {
  ...
  return (
    ...
    >
      <input ref={refInput} type="text" placeholder="Focus me" />
      <CandidateButton onClick={() => refInput.current.focus()}>
        Set Focus
      </CandidateButton>
      <br />
      <CandidateButton onClick={removeBtn}>{counter}</CandidateButton>
